document.addEventListener('DOMContentLoaded', () => {
    ...
    // Detectar el evento de scroll y aplicar la clase 'scrolled'
    const handleScroll = () => {
    ...
    window.addToCart = (product_id) => {
        ...
        // Configurar Toastr para incluir el botón de cierre
        toastr.options = {
            "closeButton": true,
        };
        toastr.success(`¡Has añadido ${productName} a tu carrito de compra!`, "Felicidades!");
        addCartToHTML();
        addCartToMemory();
    };
    ...
    loadPage = async function(page) {
        ...
        page === 'inicio' ? body.classList.add('inicio') : body.classList.remove('inicio');
        try {
